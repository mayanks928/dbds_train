		...
		<form action="searchTrains.jsp" method="GET">
			...
			<label for="destination">Destination</label> <select id="destination"
				...
				if (originId != null) {
					...
					String destinationQuery = "SELECT DISTINCT s.station_id, s.station_name " + "FROM Transit_Stop ts "
							+ "JOIN Station s ON ts.station_id = s.station_id " + "WHERE ts.transit_id IN (" + transitIdList
							+ ") " + "AND ts.station_id != " + originId + " " + "ORDER BY s.station_name";
