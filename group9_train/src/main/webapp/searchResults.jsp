...
<div class="container mt-5">
    ...
    <!-- Search Form -->
    <form class="form-inline justify-content-center mb-4" method="post" action="searchResults.jsp">
        <input type="text" class="form-control mr-2 w-50" name="search" placeholder="Search by keyword..." />
    ...
    <div>
        ...
        %>
        <div class="alert alert-warning text-center">Please enter a keyword to search.</div>
        <%
        } else {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (rs.getInt("customer_id") == customerId) {
                        ...
                        otherQuestions.putIfAbsent(questionId, questionData);
                    }
            ...
            <div class="card-body">
                ...
                if (replies != null) {
                    for (Map<String, Object> reply : replies) {
                        String replyClass = "Customer".equals(reply.get("posted_by")) ? "text-primary font-weight-bold" : "text-danger font-weight-bold";
                %>
                ...
                <!-- Reply Form for user -->
                <form method="post" action="postReply.jsp">
                    <textarea class="form-control mb-2" name="replyBody" required placeholder="Write your reply..."></textarea>
        ...
        <h3 class="text-secondary">Other Questions:</h3>
        <%
                }

                // Display results: Other questions
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <h6>Replies:</h6>
                <%
                // Display all replies for other questions
                List<Map<String, Object>> replies = repliesByQuestionId.get(entry.getKey());
                if (replies != null) {
                    for (Map<String, Object> reply : replies) {
                        String replyClass = "Customer".equals(reply.get("posted_by")) ? "text-secondary font-weight-bold" : "text-danger font-weight-bold";
                %>
                <p class="<%= replyClass %>"><%= reply.get("reply_body") %> (<%= reply.get("posted_by") %>)</p>
                <%
                    }
        ...
        <%
                ...
                e.printStackTrace();
        %>
        <div class="alert alert-danger">An error occurred while fetching the data. Please try again later.</div>
        <%
            } finally {
                try {
                    if (rs != null) rs.close();
