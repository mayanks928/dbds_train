...
<body class="bg-light">
	<div class="container my-5 p-4 bg-white rounded shadow">
		...
		<!-- Search Form -->
		<form method="post" action="crSearchResults.jsp"
		...
		<h2 class="text-secondary">User Questions:</h2>
		...
		<div class="card mb-3">
			<div class="card-body">
				...
				<h5 class="text-secondary">Your Replies:</h5>
				<%
				List<Map<String, Object>> replies = repliesByQuestionId.get(entry.getKey());
				if (replies != null) {
					for (Map<String, Object> reply : replies) {
						String replyClass = "Customer".equals(reply.get("posted_by")) ? "text-primary fw-bold" : "text-danger fw-bold";
				%>
				...
				<form method="post" action="crPostReply.jsp" class="mt-3">
					<textarea name="replyBody" class="form-control mb-3" rows="3"
